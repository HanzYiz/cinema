            ...
            <div class="col-md-3">
                <div class="card stat-card bg-primary text-white">
                    <div class="card-body">
                        ...
                        <h3><?= $stats['pending'] ?></h3>
                        <a href="list.php?status=pending" class="text-white">Lihat Detail</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card stat-card bg-success text-white">
                    <div class="card-body">
                        ...
                        <a href="list.php?status=paid" class="text-white">Lihat Detail</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card stat-card bg-info text-white">
                    <div class="card-body">
                        ...
                        <a href="list.php?status=today" class="text-white">Lihat Detail</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                            ...
                            <tbody>
                                <?php foreach ($pendingPayments as $payment): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="verify.php?id=<?= $payment['id'] ?>" 
                    ...
                    <div class="text-end">
                        <a href="list.php?status=pending_verification" class="btn btn-outline-primary">
