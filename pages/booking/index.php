...
async function loadSeatMapWithCapacity(studioId) {
    ...
    try {
        ...
        const seatsResponse = await fetch(`get_booked_seats.php?studio_id=${studioId}&schedule_id=${currentScheduleId}`);
...
async function submitBooking() {
    ...
    try {
        ...
        const response = await fetch('../../api/booking/process_booking.php', {
            method: 'POST',
            headers: {
        ...
        if (data.success) {
            ...
            window.location.href = `../../api/booking/booking_confirmation.php?booking_id=${data.booking_id}`;
        } else {
